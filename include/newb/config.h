...
#define NL_CONSTRAST 0.97   // 0.3 low ~ 2.0 high
...
#define NL_NIGHT_BRIGHTNESS 1.2 // 0.0 dark ~ 2.0 bright
...
#define NL_DAY_ZENITH_COL    vec3(0.17,0.44,0.94)     // Day Zenith Color
#define NL_DAY_HORIZON_COL   vec3(0.75,0.84,1.0)      // Day Horizon Color
#define NL_NIGHT_ZENITH_COL  vec3(0.02,0.05,0.13)     // Night Zenith Color
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.16,0.34)     // Night Horizon Color
#define NL_RAIN_ZENITH_COL   vec3(0.85,0.9,1.0)       // Rain Zenith Color
#define NL_END_ZENITH_COL    vec3(0.93, 0.11, 0.76)    // End Zenith Color (Colorful)
#define NL_END_HORIZON_COL   vec3(0.09, 0.91, 0.85)    // End Horizon Color
#define NL_RAIN_HORIZON_COL  vec3(1.0,1.0,1.0)        // Rain Horizon Color
#define NL_DAWN_HORIZON_COL  vec3(1.0,0.4,0.3)        // Dawn Horizon Color
#define NL_DAWN_EDGE_COL     vec3(1.0,0.4,0.2)        // Dawn Edge Color
#define NL_DAWN_ZENITH_COL   vec3(1.0,0.4,0.2)        // Dawn Zenith Color
...
/* ------ SUBPACK CONFIG STARTS HERE -------- */
 ...
 #undef NL_FOG_TYPE              // 0:no fog, 1:vanilla, 2:smoother vanilla
#undef NL_MIST_DENSITY 
#define NL_FOG_TYPE 2             // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY 0.01 
...
#ifdef Mid
  #undef NL_FOG_TYPE
 #undef NL_CLOUD2_THICKNESS 2.7     // 0.5 slim ~ 5.0 fat
#undef NL_CLOUD2_RAIN_THICKNESS 2.5 // 0.5 slim ~ 5.0 fat
#undef NL_CLOUD2_STEPS 13            // 3 low quality ~ 16 high quality
#undef NL_CLOUD2_SCALE 0.03        // 0.003 large ~ 0.3 tiny
#undef NL_CLOUD2_SHAPE 0.8          // 0.0 round ~ 1.0 box
#undef NL_CLOUD2_DENSITY 79.0       // 1.0 blurry ~ 100.0 sharp
#undef NL_CLOUD2_VELOCIY 1.3
 #define NL_CLOUD2_THICKNESS 2.7     // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_RAIN_THICKNESS 2.5 // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_STEPS 13            // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE 0.03        // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_SHAPE 0.8          // 0.0 round ~ 1.0 box
#define NL_CLOUD2_DENSITY 79.0       // 1.0 blurry ~ 100.0 sharp
#define NL_CLOUD2_VELOCIY 1.3
